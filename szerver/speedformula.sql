...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 11. 13:29
...
(1, 'tesztadmin', 'Adminteszt@gmail.com', '$2b$10$0RCIYXkaYCTmmcwkftSEfuae.u1ztPwhAj1hsA1T.14urVhgeXxhu', 8, 2, 1, '../assets/pfp/pfp_dark-pink.png', ''),
(2, 'tesztfiok1', 'Simatesztfiok@gmail.com', '$2b$10$ckq668ySCKIbtxGrAS.fk.CbnX.ifAs65.gm1i7wjN1a8DAV/QKTe', 8, 2, 1, '../assets/pfp/pfp_dark-cyan.png', '');
...
--
-- A tábla adatainak kiíratása `ujtoken`
--

INSERT INTO `ujtoken` (`id`, `token`, `felhasznalo_id`) VALUES
(1, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZmVsaGFzem5hbG9uZXYiOiJ0ZXN6dGFkbWluIiwiaWF0IjoxNzQxNjk1ODM1LCJleHAiOjE3NDIzMDA2MzV9.cBLYK5cg9oVF1x-uWGR_jP3aPp4Zpp1h2c1BGvrJ_RQ', 1);
